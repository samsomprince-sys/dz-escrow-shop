    ...
    <div className="min-h-screen bg-slate-950 p-6 flex flex-col items-center" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-6xl w-full flex justify-between items-center mb-6 px-2 gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/merchant/auth?lang=${lang}`} className="flex items-center gap-2.5 bg-slate-900 hover:bg-slate-850 text-white font-medium py-2 px-4 rounded-xl border border-slate-800 transition-all text-xs group">
      ...
      <div className="max-w-6xl w-full bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-8 rounded-2xl shadow-xl border border-slate-800 text-center mb-8">
        ...
        <div className="flex flex-wrap gap-4 justify-center border-t border-slate-800 pt-6">
          <Link href={`/admin/dashboard?lang=${lang}`} className="bg-slate-800 hover:bg-slate-700 text-white font-bold py-2.5 px-5 rounded-xl transition-all shadow-sm text-xs border border-slate-700">{t.adminBtn}</Link>
          <Link href={`/merchant/dashboard?lang=${lang}`} className="bg-green-600 hover:bg-green-700 text-white font-bold py-2.5 px-5 rounded-xl transition-all shadow-sm text-xs">{t.merchantBtn}</Link>
          <Link href={`/merchant/add-product?lang=${lang}`} className="bg-amber-500 hover:bg-amber-600 text-white font-bold py-2.5 px-5 rounded-xl transition-all shadow-sm text-xs">{t.addProdBtn}</Link>
        </div>
      </div>
